		...
		<div class="bg-white rounded-2xl shadow-xl p-8">
			...
			<div class="space-y-3 mb-6">
				...
				<button
					...
					class="w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-300 rounded-lg text-gray-700 bg-white hover:bg-blue-500 active:bg-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-200 font-medium"
				>
				...
				<button
					...
					class="w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-300 rounded-lg text-gray-700 bg-white hover:bg-gray-600 focus:ring-2 focus:ring-gray-600 focus:ring-offset-2 transition-all duration-200 font-medium"
				>
